...
![Version: 0.5.0-beta.6](https://img.shields.io/badge/Version-0.5.0--beta.6-a855f7.svg)
...
cosign verify ghcr.io/datasch/docentos:0.5.0-beta.6 \
...
```bash
DOCENTOS_IMAGE=ghcr.io/datasch/docentos:0.5.0-beta.6 \
...
git push datasch v0.5.0-beta.6    # el remoto de este repositorio
```
